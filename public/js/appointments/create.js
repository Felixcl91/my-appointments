 ...
 const noHoursAlert = `<div class="alert alert-danger" role="alert">
          No se encontraron horas disponibles para el médico seleccionado
      </div>`;
    ...
    function getRadioIntervalHtml(interval) {
      ...
      return `<div class="custom-control custom-radio mb-3">
        <input name="scheduled_time" value="${interval.start}" class="custom-control-input" type="radio" id="interval${iRadio}" required>
